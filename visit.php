...
$url = "http://api.scraperapi.com?api_key=".$apikey."&url=https://cashwallet.site/clickers";
$url1 = "http://api.scraperapi.com?api_key=".$apikey."&url=https://cashwallet.site/clickers.php";
$inn = curl($url,$ua,"get");
$data = "todo=post&theirusername=".$name;
